...
NUI.options = {
	...
	args = {
		addonprofiles = {
			...
			order = 1,
			hidden = function()
				if C_AddOns_IsAddOnLoaded("ElvUI") or (not C_AddOns_IsAddOnLoaded("BigWigs") and not C_AddOns_IsAddOnLoaded("Details") and not C_AddOns_IsAddOnLoaded("HidingBar") and not C_AddOns_IsAddOnLoaded("NameplateAuras") and not C_AddOns_IsAddOnLoaded("Plater") and not C_AddOns_IsAddOnLoaded("WeakAuras")) then
					return true
				end
			end,
			type = "group",
		...
		advanced = {
			...
			args = {
				loadprofiles = {
					...
					hidden = function()
						if C_AddOns_IsAddOnLoaded("ElvUI") or (not C_AddOns_IsAddOnLoaded("BigWigs") and not C_AddOns_IsAddOnLoaded("Details") and not C_AddOns_IsAddOnLoaded("HidingBar") and not C_AddOns_IsAddOnLoaded("NameplateAuras") and not C_AddOns_IsAddOnLoaded("Plater") and not C_AddOns_IsAddOnLoaded("WeakAuras")) or not NUI.db.global.profiles then
							return true
						end
					end,
					type = "execute",
